class AnimateData {
  ...
  static const baseAnimateUrl = 'assets/animations/';

  static const loginIdleAnimate = "${baseAnimateUrl}login-idle.json";
  static const loginSuccessAnimate = "${baseAnimateUrl}login-success.json";
